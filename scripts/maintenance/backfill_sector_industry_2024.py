...
YEAR = 2024
GAP_END = "2024-10-08"           # 既存が始まる日（この日より前を埋める、end 排他）
...
def main():
    ...
    merge_and_write('sector', sector_recs, load_existing(bucket, 'sector'))
    merge_and_write('industry', industry_recs, load_existing(bucket, 'industry'))
