"""
upload_jp_shares_float_to_r2.py

data/temp_shares_float_jp.json を R2 にアップロードする。
jp/stocks/shares_float/{code}.json （現在値スナップショット、常に上書き）。
"""
import os
import json
import logging
...
R2_PREFIX = "jp/stocks/shares_float/"
MAX_WORKERS = 10
